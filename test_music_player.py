...
class TestApp(unittest.TestCase):
    ...
    def test_load_images(self) -> None:
        img_dict = self.app._load_images()
        self.assertIsInstance(img_dict, dict)
        self.assertEqual(len(img_dict), 5)
    ...
    def test_add_music(self):
        ...
        assert self.app._song_list.size() == 0
        # add a song to the listbox
        self.app._click_add()
        # check if song is added to the listbox
        assert self.app._song_list.size() == 1
    ...
    def test_play_music(self, mock_play, mock_load):
        ...
        self.app._song_list.insert('end', 'risk.mp3')
    ...
    def test_pause_music_with_selected_song_not_playing(self, mock_messagebox):
        ...
        self.app._song_list.selection_set('end')
        self.app._click_play()
        self.app._song_list.insert('end', 'drop-it.mp3')
        self.app._song_list.selection_set('end')
        self.app._song_list.activate('end')
        self.app._click_pause()
    ...
    def test_click_next(self, mock_play, mock_load):
        ...
        self.app._song_list.insert('end', 'risk.mp3')
        self.app._song_list.insert('end', 'drop-it.mp3')
        self.app._song_list.selection_set(0)
        self.app._song_list.activate(0)
        self.app._click_next()
